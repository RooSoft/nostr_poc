defmodule NostrPocWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NostrPocWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NostrPocWeb.Gettext, "errors", msg, opts)
    end
  end
